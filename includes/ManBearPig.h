...
// Memory Ranges
`define memory_size_lo 32'h400000
`define memory_size_hi 32'h8000000

/*----------------------------------------------------------------------------*
 * Instruction Fields                                                         *
 *----------------------------------------------------------------------------*/

`define opcode       31:26  // 6-bit operation code
`define rs           25:21  // 5-bit source register specifier
`define rt           20:16  // 5-bit source/dest register spec or sub opcode
`define imm          15:0   // 16-bit immediate, branch or address disp
`define jump_imm     25:0   // 26-bit jump target address
